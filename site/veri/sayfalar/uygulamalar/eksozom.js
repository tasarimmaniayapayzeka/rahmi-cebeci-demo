...
<section class="g-hero">
  <div class="sar">
    <div>
      ...
      <p class="g-etiket">Enjeksiyonla Yapılanlar · Hücreler Arası Sinyal</p>
      ...
      <div class="g-tikler"><span><i></i>İçinde canlı hücre yok</span><span><i></i>Verinin sınırı gizlenmez</span><span><i></i>Ürün kaydı dosyada</span></div>
    </div>
...
<section class="bolum bolum--sicak">
  <div class="sar">
    ...
    <div class="g-bento">
      ...
      <div class="g-kutu g-b2 g-kutu--gece" data-gr><span class="g-ket">Hekimin notu</span><p>“Emin olmadığımız bir sonucu vaat etmeyiz; neyi bildiğimizi ve neyi henüz bilmediğimizi aynı açıklıkla söyleriz.”</p></div>
      <div class="g-kutu g-b2 g-kutu--gorsel" data-gr style="--d:70ms"><img src="${r}varliklar/gorsel/uyg-eksozom-kutu.webp" alt="Altın renkli sıvı içinde süzülen küçük saydam kesecikler" loading="lazy"><span class="g-ainot">Temsilî görsel · yapay zekâ ile üretildi</span></div>
      <div class="g-kutu g-b2 g-kutu--cta" data-gr style="--d:140ms"><h3>Beklentinizi birlikte tartalım</h3><p>Kararsız kaldığınızda uygulamayı ertelemek de sağlıklı bir seçimdir.</p><a class="dgm dgm--altin" href="${r}iletisim/">Randevu isteyin</a></div>
