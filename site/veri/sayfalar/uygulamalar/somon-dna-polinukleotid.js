...
<section class="g-hero">
  <div class="sar">
    <div>
      ...
      <p class="g-hero__alt">Polinükleotid uygulamasında, balık kaynaklı DNA’dan elde edilip saflaştırılmış kısa nükleotid zincirleri çok ince iğnelerle derinin alt katmanlarına verilir. Halk arasındaki “somon DNA” adı bu hammaddeden gelir. Amaç, cildin kendi onarım süreçlerini desteklemektir; hacim eklemez ve etkisi kişiden kişiye değişir. Uygunluk, muayene ve öykü değerlendirmesinden sonra belirlenir.</p>
...
<div class="g-band"><div class="sar">
  ...
  <div data-gr style="--d:60ms"><b><em data-gsay="24">0</em>&#8239;sa</b><span>Sauna ve spora ara</span></div>
  <div data-gr style="--d:120ms"><b>Dermis</b><span>Hedeflenen katman</span></div>
  <div data-gr style="--d:180ms"><b>Dizi</b><span>Seanslara yayılan program</span></div>
</div></div>
...
<p>Bu nedenle uygulamayı adıyla değil içeriğiyle konuşuyoruz: size uygulanacak ürünün adı, içeriği, miktarı ve uygulandığı bölgeler dosyanıza kaydedilir. İçerikle ilgili merak ettiğiniz her şeyi uygulamadan önce sorabilirsiniz.</p>
    ...
    <div class="kutu" data-gr style="--d:200ms;margin-top:16px">
      <p>Pürüzlü bir yüzey ya da belirgin gözenekler sizi rahatsız ediyorsa <a href="${r}cilt-sorunlari/gozenek-ve-cilt-dokusu/">gözenek ve cilt dokusu</a>, cildiniz kuru ve mat görünüyorsa <a href="${r}cilt-sorunlari/nem-kaybi-ve-donukluk/">ciltte nem kaybı ve donukluk</a> sayfasından başlayabilirsiniz. Göz çevresine ve yüzün bütününe özel planlamayı ayrıca anlattık: <a href="${r}bolgeler/goz-cevresi/">göz çevresi</a>, <a href="${r}bolgeler/yuz/">yüz</a>.</p>
    </div>
  </div>
</section>
  ...
  <div class="sar">
    ...
    <div class="g-bento">
      <div class="g-kutu g-b2 g-donutkap" data-gr>
        <div class="g-donut"><svg viewBox="0 0 100 100" width="100" height="100"><circle class="g-iz" cx="50" cy="50" r="45"/><circle class="g-dol" data-gyuzde="66" cx="50" cy="50" r="45"/><circle class="g-kom" cx="50" cy="50" r="45"/></svg><b>24 sa</b></div>
      ...
      <div class="kutu kutu--uyari g-b4" data-gr>
        ...
        <ul>
          ...
          <li><b>Beklentinin uygulamayla örtüşmemesi:</b> belirgin hacim kaybının ya da sarkmanın giderilmesi bekleniyorsa bu uygulama önerilmez.</li>
        </ul>
      </div>
