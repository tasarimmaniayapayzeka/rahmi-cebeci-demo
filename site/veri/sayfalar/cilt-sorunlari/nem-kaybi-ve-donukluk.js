...
<p>Direnen tablolarda tiroit bozuklukları, kansızlık, bazı ilaçlar ve düzensiz uyku gibi genel etkenler de ele alınır.</p>
    ...
    <div class="kutu kutu--bilgi" data-gr style="margin-top:26px">
      ...
      <p>Koruyucu katmanı zayıflamış bir ciltte ilk adım bir şey eklemek değil, bir şeyleri bırakmaktır. Önce kullandığınız bütün ürünler, sırası ve sıklığıyla birlikte konuşulur; cildi zorlayan adımlar çıkarılır ve cilde alışması için zaman tanınır. Pek çok ciltte bu dönemde, yaklaşık bir ila bir buçuk ay içinde belirgin bir toparlanma görülür.</p>
