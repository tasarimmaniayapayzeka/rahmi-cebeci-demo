...
<section class="bolum bolum--sicak" id="nedenler">
  <div class="sar">
    ...
    <div class="kutu kutu--uyari" data-gr style="margin-top:26px">
      ...
      <p>Birkaç hafta ya da ay içinde büyüyen, kanayan, kabuk bağlayan, bir türlü iyileşmeyen ya da renkleri eşit dağılmayan bir kabarıklık estetik bir konu değildir. Böyle bir lezyona muayenede dermatoskopla bakılır; ancak bu bakış tanı yerine geçmez. Bu bulgulardan biri varsa vakit kaybetmeden bir dermatoloji uzmanı tarafından değerlendirilmeniz önerilir; tanı konmadan bu alana estetik bir işlem uygulanmaz.</p>
    </div>
  </div>
</section>
